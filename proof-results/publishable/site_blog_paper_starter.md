# Site/Blog/Paper Starter Pack

Generated from tracked proof bundles.

## Use this first

1. `tables/focus_evidence_table_compact.md`
2. `charts/focus_margin_context.png`
...
- recurring_workflows scorecard: `../recurring_workflows_10seed/publishable_key_results_compact.md`
- sparse_feedback scorecard: `../sparse_feedback_10seed/publishable_key_results_compact.md`
- cross-bundle quick table: `tables/focus_evidence_table_compact.md`
- cross-bundle chart: `charts/focus_margin_context.png`
...
- compact numeric table: `tables/focus_evidence_table_compact.csv`
- full numeric table: `tables/focus_evidence_table.csv`
- ablation figure: `charts/focus_ablation_ladder.png`
- margin/context figure: `charts/focus_margin_context.png`
